...
export const plans = [
  ...
  },
  {
    ...
    features: [
      "All Basic features",
      "2 Flushes Per Day",
      "Mood-Based Flushes (Beta)", 
      "1TB AI Enhanced Flush Storage",
    ],
  ...
  {
    id: "2",
    title: "FlushGPT+ Enterprise",
    priceMonthly: 350,
    priceYearly: 326,
    caption: "Built for enterprise-grade heavy-duty flushes",
    features: [
      "All FlushPRO features",
      "5 Flushes Per Day",
      "Personal Flush Coach (GPT-4-powered)",
      "Real-time flush syncing and collaboration",
    ],
